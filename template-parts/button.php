...
<div class="otter_open otw-floating-cart <?php if($scroll === 1){ echo 'otter_woo_scroll otw-woo-hide';}?> <?php if($shadow === 1){ echo 'otter_woo_shadow';}?> <?php echo get_theme_mod( 'woo_otterwp_floating_cart_position', ('right-bottom-fixed')); ?>">
 ...
 <div class="otter_open_image">
		...
		?>
			...
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  viewBox="0 0 18 23" version="1.1">
		<g stroke="none" stroke-width="2" fill="none" fill-rule="evenodd">
			<g transform="translate(-1225.000000, -10.000000)" fill="#000">
...
<?php
	...
	?>
		 <p class="otter_icon_title"> <?php echo $title;?> </p> <?php
